...
public class FilterConditionEntity {
   ...
   */
  public FilterConditionEntity(FilterParameter parameter, FilterComparator comparator, String val)
    ...
    try {
      ...
      throw new FilterSyntaxError(FilterSyntaxErrorReason.PARAMETER_VALUE_UNCASTABLE,
  ...
  public String toString() {
    return String.format("%s %s %s", this.parameter.getSyntax(), this.comparator.getSyntax(),
        this.val);
  }
}
